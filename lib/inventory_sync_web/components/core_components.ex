defmodule InventorySyncWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: InventorySyncWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InventorySyncWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InventorySyncWeb.Gettext, "errors", msg, opts)
    end
  end
