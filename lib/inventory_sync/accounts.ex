defmodule InventorySync.Accounts do
  @moduledoc """
  ...
  alias InventorySync.Accounts.{User, UserToken, UserNotifier}
  ...
  See `InventorySync.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `InventorySync.Accounts.User.password_changeset/3` for a list of supported options.
