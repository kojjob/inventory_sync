...
config :inventory_sync, InventorySyncWeb.Endpoint,
  ...
  secret_key_base: "sKQug70OYyqjCHBBTQaqW2gW5FIByEy6TwWEq3/+xkKHT66jbW5DiPxM8+6zQkge",
  server: false

# In test we don't send emails
config :inventory_sync, InventorySync.Mailer, adapter: Swoosh.Adapters.Test
